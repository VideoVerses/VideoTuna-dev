...
from videotuna.models.framepack.utils import crop_or_pad_yield_mask
...
def encode_prompt_conds(prompt, text_encoder, text_encoder_2, tokenizer, tokenizer_2, max_length=256):
    ...
    print("llama_input_ids.device = ", llama_input_ids.device)
    print("llama_attention_mask.device = ", llama_attention_mask.device)

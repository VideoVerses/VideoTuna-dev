...
class HunyuanVideoPackedFlow(GenerationBase):
    ...
    def inference(self, args: DictConfig): 
        ...
        video_length_in_second = 2  # 固定为2秒
        prompt = "A seamless transition between two images, smooth and natural camera movement.[0s-1s]: first image [1s]: camera follows the motion rightward. The background gradually shifts.[2s]: second image. Seamless transition with gentle camera pan"

...
class DDIMSampler(object):
    ...
    def p_sample_ddim(
        ...
        **kwargs,
        ...
        unconditional_conditioning_img_nonetext = kwargs[
            "unconditional_conditioning_img_nonetext"
        ]
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            ...
            e_t_uncond_img = self.model.apply_model(
                x, t, unconditional_conditioning_img_nonetext, **kwargs
            )
            # text cfg
            model_output = (
                e_t_uncond
                + cfg_img * (e_t_uncond_img - e_t_uncond)
                + unconditional_guidance_scale * (e_t_cond - e_t_uncond_img)
            )
        ...
        sigmas = (
            self.ddim_sigmas_for_original_num_steps
            if use_original_steps

...
if __name__ == "__main__":
    ...
    if "train" in config.data.params and config.data.params.train.target == "lvdm.data.hdvila.HDVila" or \
            ("validation" in config.data.params and config.data.params.validation.target == "lvdm.data.hdvila.HDVila"):
